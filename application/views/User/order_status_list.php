        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-list"></i> List Order Status Information</h3>
              <div class="card-tools">
                <a href="<?php echo base_url(); ?>Master/order_status" class="btn btn-sm btn-block btn-primary">Add Order Status</a>
              </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
