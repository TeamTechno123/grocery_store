              ...
              <form class="m-0 input_form" id="form_action" role="form" action="" method="post" enctype="multipart/form-data">
                <div class="card-body row">
                  <div class="col-md-8 offset-md-2">
                    <div class="row">
                      ...
                      <div class="form-group col-md-12">
                        <label>Manufacturer Sequence</label>
                        <input type="text" class="form-control form-control-sm" name="manufacturer_sequence" id="manufacturer_sequence" value="<?php if(isset($manufacturer_sequence)){ echo $manufacturer_sequence; } ?>" placeholder="" required>
                      </div>
                      <div class="form-group col-md-12">
                ...
                <div class="card-footer row">
                  ...
                  <div class="col-md-6 text-right">
                    ...
                    <?php } ?>
                    <a href="<?php echo base_url() ?>Master/manufacturer_list" class="btn btn-default ml-4">Cancel</a>
                  </div>
                </div>
              </form>
            </div>
