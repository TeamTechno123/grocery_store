...
<section class="default-page">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h1 class="page-heading">Cancellation Policy</h1>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      <div class="col-md-10 offset-md-1">
        ...
        <p class="text-div">In general case of exchange/replacement/return due to above-mentioned quality issues and a written proof from the customer following refund policies are applicable:</p>
          <ol>
            <li class="text-div">If a customer doesn’t wish to avail the replacement, we issue a voucher of the same value to the customer to be availed within a specified time period mentioned on that.</li>
            <li class="text-div">In case of order cancellation/return through card/Net banking we credit the money back to your credit/debit card or Net Banking which takes up to 10 to 15 working days to reflect in your statement.</li>
            <li class="text-div">In any of the above case delivery charges are non-refundable if any.</li>
          </ol>
          <p class="text-div">Note: Under no circumstances, the customer would be given a cash refund</p>
        </div>
    </div>
  </div>
</section>
