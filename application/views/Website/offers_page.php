...
<section class="cookbook-page">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <img class="cookbook-img p-30" src="<?php echo base_url(); ?>assets/images/voucher1.png" alt="" width="100%">
      </div>
    ...
    <div class="row">
      <div class="col-md-10 offset-md-1">
         ...
         <ol>
           ...
           <li class="text-div"> can change the terms and conditions related to any available coupon codes on the website without any prior intimation</li>
